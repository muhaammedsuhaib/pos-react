...
function AggregatorCard({status,customer,orderId}) {
  return (
    ...
    <div className="w-full h-[134px] rounded-[10px] bg-[#C74B3E] mediumShadow overflow-hidden">
      <div className="">
        <div className=" w-full px-[10px]">
          <div className="w-[full] text-white rounded-[20px] font-medium text-center  text-[13px]">
          AGGREGATOR
          </div>
        </div>
        <div className="w-full flex items-center justify-center h-[52px]">
          <img src={aggregatorIcon} alt="" className="w-[50px]" />
        </div>
