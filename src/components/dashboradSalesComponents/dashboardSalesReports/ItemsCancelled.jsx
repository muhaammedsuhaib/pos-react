...
import { selectItemCancelled } from "../../../reducer/sales/reducer";
import { listItemCancelled } from "../../../reducer/sales/actions";
          ...
          <div className="flex flex-col items-start mt-3 p-2 space-y-2 ml-10">
            ...
            <div className="flex items-center space-x-10">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-white text-sm">AGGREGATOR</span>
              </div>
            </div>
            {/* Second Row */}
            <div className="flex items-center space-x-10">
