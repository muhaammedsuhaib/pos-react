    ...
    <div className="pt-4">
      ...
      <div className="py-2 p-1 xl:p-3 space-y-2">
        <div className=" flex justify-between items-center gap-3 w-full 3xl:w-[95%]">
          <div className="h-[35px] bg-primeryFirst text-white rounded-[30px] flex justify-between items-center w-[75%] xl:w-[70%] px-5 pr-3">
            <div className="w-[30%]">
            ...
            <div className="w-[20%] flex justify-end">
              <p className="font-bold text-sm xl:text-[16px]">AED 3,553.75</p>
            </div>
          </div>
          <div className="w-[3%]">
        ...
        <div className=" flex justify-between items-center gap-3 w-full 3xl:w-[95%]">
          <div className="h-[35px] bg-[#F7C6BD] rounded-[30px] flex justify-between items-center w-[75%] xl:w-[70%] px-5 pr-3">
            <div className="w-[30%]">
              <p className="uppercase font-medium text-[12px] 3xl:text-[16px] ">
                fund added to petty cash
              </p>
            </div>
            <div className="w-[52%]">
              <div className="w-full h-[20px] rounded-[30px] bg-[#DDEAD2] flex gap-2 items-center progress-container">
