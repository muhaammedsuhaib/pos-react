...
import "./kitchen_completed.css";
import { FaCheck, FaChevronDown } from "react-icons/fa";
import { IoClose, IoCloseSharp } from "react-icons/io5";
import { useState } from "react";
import { TiTick } from "react-icons/ti";

const Kitchen_completed = () => {
  ...
  return (
    <div className="mb-[15px] rounded-[10px] overflow-hidden">
      ...
      {/* </div> */}
      <div className="w-full bg-[#63A654] px-[5px] ">
        ...
        <div className="w-full px-[5px]">
          <div className="w-full xl:h-[50px] h-[40px] bg-[#BEDDAB] border-[2px] rounded-[30px] flex flex-col justify-center items-center font-medium leading-[15px]">
          ...
          <div className="w-full rounded-[10px] bg-[#DCFBE7] py-[5px] mt-[8px] px-[2px]">
            <div className="w-full rounded-[20px] h-[25px] flex items-center justify-center xl:text-[13px] text-[11px] text-white py-[2px] bg-[#A9D18E]">
              <p>MAIN KITCHEN</p>
            </div>
            <div className="w-full flex items-center  justify-between border-dashed border-b-[1px] border-[#63A654] py-[2px] px-[3px] pr-[5px]">
            ...
            <div className="w-full flex items-center  justify-between border-dashed  border-[#63A654] py-[2px] px-[3px] pr-[5px]">
              <div className="flex items-center space-x-[3px]">
            ...
            <div className="w-full rounded-[20px] flex items-center justify-center text-[12px] text-white py-[2px] bg-[#A9D18E]">
              <p>BAR AREA</p>
            </div>
            <div className="w-full flex items-center  justify-between border-dashed border-b-[1px] border-[#63A654] py-[2px] px-[3px] pr-[5px]">
              <div className="flex items-center space-x-[3px]">
...
export default Kitchen_completed;
