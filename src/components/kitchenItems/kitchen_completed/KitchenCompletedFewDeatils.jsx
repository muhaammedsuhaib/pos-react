...
function KitchenCompletedFewDeatils() {
  return (
    <div className="mb-[15px] rounded-[10px] overflow-hidden">
      <div className="w-full bg-[#63A654] px-[5px]  ">
        <div className="w-full flex items-center justify-between pt-[10px] px-[5px]">
          <div className="text-black font-semibold px-[15px] rounded-[20px] xl:text-[17px] lg:text-[14px] text-[12px] bg-[#DCFBE7]">
            <p>KOT : 33</p>
          </div>
          <div className="text-black font-semibold px-[15px] rounded-[20px] xl:text-[17px] lg:text-[14px] text-[12px] bg-[#DCFBE7]">
            <p>TABLE-7</p>
        ...
        <div className="w-full px-[5px]">
          <div className="w-full rounded-[10px] bg-[#DCFBE7] py-[2px] mt-[5px] pl-[2px]">
...
export default KitchenCompletedFewDeatils;
