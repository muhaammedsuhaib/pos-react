...
function NewBookinEdiit({ open, closeAction, ...props }) {
              ...
              <div className="w-[45%] flex justify-end gap-1 mt-6">
                <Form.Item className=" mb-3">
                  <div className=" flex items-center gap-[2px]">
                    <label htmlFor="tableReq" className="text-white cursor-pointer">
                      Table Required
                    </label>
                    <button
                      onClick={handleClick}
            ...
            <div className="p-3 text-white flex justify-between items-center gap-8">
              ...
              <div className=" text-white flex justify-center items-center gap-4">
                <button
                  ...
                  className="bg-primeryFirst hover:bg-transparent rounded-[8px] leading-4 py-[4px] px-5  w-[120px] border hover:border-white active:bg-primerySecond uppercase"
                >
                  {editText ? "update& close" : "edit booking"}
                </button>
                <button className="bg-primeryFirst hover:bg-transparent rounded-[8px] leading-4 py-[4px] px-4  w-[120px] border hover:border-white active:bg-primerySecond uppercase">
