...
function NewBookingOrder() {
  ...
  return (
    <Modal
      ...
      footer={null}
      title="NEW BOOKING ORDER (NO. 32355)"
      width={650}
      open
    >
      <div className="w-full new-booking-form ">
        ...
        <Form layout="vertical">
          ...
          <div className="bg-black rounded-b-[10px]">
            <div className="bg-[#F9BB00] p-1 flex justify-between items-center yellow-content">
            ...
            <div className="p-2 flex justify-between items-center gap-2">
              ...
              <div className="font-medium w-[80%] flex justify-center items-center gap-2">
                <button
                  onClick={() => setEditText((prevEditText) => !prevEditText)}
                  className="bg-[#D1D7E0] hover:bg-transparent hover:text-white rounded-[8px] leading-4 py-[4px] px-3  w-[100px] border hover:border-white active:bg-primeryFirst uppercase"
                >
                  {editText ? "update & close" : "edit booking"}
                </button>
                <button className="bg-[#D1D7E0] hover:bg-transparent hover:text-white  rounded-[8px] leading-4 py-[4px] px-4  w-[140px] border hover:border-white active:bg-primeryFirst uppercase">
                  proceed to order/K.O.T
                </button>
                <button className="bg-[#F90000] hover:bg-transparent text-white rounded-[8px] leading-4 py-[4px] px-3  w-[100px] border hover:border-white active:bg-primeryFirst uppercase">
                  reject <br /> booking
                </button>
                <button className="bg-[#00AC4E] hover:bg-transparent  text-white rounded-[8px] leading-4 py-[4px] px-3  w-[100px] border hover:border-white active:bg-primeryFirst uppercase">
                  accept booking
                </button>
              </div>
            </div>
...
export default NewBookingOrder;
